...
int n,x,i,y,f,f1,f2,choice,pos,temp,tempo;
char ch='y';
while(ch=='y')
{   f=1,f1=1,f2=1,pos=0,temp=10;
	...
	switch(choice)
	{
		...
		case 3: cout<<"SIMULATION 3....."<<endl;
				...
				if(f2==0)
				 {
					 cout<<endl<<"the cloth must be cut from "<<pos+1<<" position";
					 cout<<endl<<"the updated stack is"<<endl;
					 c[pos]=c[pos]-y;
					 for(i=n-1;i>=0;i--)
					 {
				 ...
				 {
					 cout<<"suitable cloth not found"<<endl;
					 cout<<"the updated stack is"<<endl;
					 for(i=n-1;i>=0;i--)
					 {
						 cout<<c[i]<<endl;
